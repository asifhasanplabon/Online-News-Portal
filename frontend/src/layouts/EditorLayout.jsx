...
import { LayoutDashboard, FileText, PenSquare, LogOut, Newspaper } from "lucide-react";
import toast from "react-hot-toast";

const links = [
  { to: "/editor/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { to: "/editor/my-news", label: "My News", icon: FileText },
  { to: "/editor/create-news", label: "Write News", icon: PenSquare },
];
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-56 bg-gray-900 text-white flex flex-col">
        <div className="flex items-center gap-2 px-5 py-4 border-b border-gray-700">
          ...
          <span className="font-bold text-sm">Editor Panel</span>
        </div>
